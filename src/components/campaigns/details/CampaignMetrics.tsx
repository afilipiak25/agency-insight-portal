    ...
    <div className="grid grid-cols-5 gap-4">
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <Progress value={parseInt(campaign.sourced || '0')} className="h-1.5 mt-2 bg-gray-100" progressColor="bg-black" />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <Progress value={parseInt(campaign.activated || '0')} className="h-1.5 mt-2 bg-gray-100" progressColor="bg-black" />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <Progress value={parseInt(campaign.opened || '0')} className="h-1.5 mt-2 bg-gray-100" progressColor="bg-black" />
        </CardContent>
      </Card>
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <Progress value={parseInt(campaign.replied || '0')} className="h-1.5 mt-2 bg-gray-100" progressColor="bg-black" />
        </CardContent>
      </Card>
    </div>
  );
