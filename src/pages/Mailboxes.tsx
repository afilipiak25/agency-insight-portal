    ...
    <Layout>
      <div className="p-8 max-w-7xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-2xl font-semibold mb-2">Mailboxes</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {mailProviders
                  ...
                  .map(provider => (
                    <button
                      key={provider.id}
                      className="flex items-center gap-3 p-4 rounded-lg border hover:border-violet-400 hover:bg-violet-50 transition-all"
                    >
